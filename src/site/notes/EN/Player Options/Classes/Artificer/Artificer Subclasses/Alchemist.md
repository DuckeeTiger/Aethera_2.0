---
{"dg-publish":true,"permalink":"/en/player-options/classes/artificer/artificer-subclasses/alchemist/","noteIcon":"","dg-note-properties":{"tr_id":"alchemist","tr_lang":"en","translation":"[[Alkimista (Alchemist)]]"}}
---
...
>
> An Alchemist is an expert at combining reagents to produce magical effects.
>
> Alchemists use their creations to give life and to leech it away.
...
>> | ----- | ----- |
>> | 3 | [[EN/Player Options/Spells/Detailed Spells/Healing Word\|Healing Word]], [[EN/Player Options/Spells/Detailed Spells/Ray of Sickness\|Ray of Sickness]] |
>> | 5 | [[EN/Player Options/Spells/Detailed Spells/Flaming Sphere\|Flaming Sphere]], [[EN/Player Options/Spells/Detailed Spells/Melf's Acid Arrow\|Melf's Acid Arrow]] |
>> | 9 | [[EN/Player Options/Spells/Detailed Spells/Gaseous Form\|Gaseous Form]], [[EN/Player Options/Spells/Detailed Spells/Mass Healing Word\|Mass Healing Word]] |
>> | 13 | [[EN/Player Options/Spells/Detailed Spells/Death Ward\|Death Ward]], [[EN/Player Options/Spells/Detailed Spells/Vitriolic Sphere\|Vitriolic Sphere]] |
>> | 17 | [[EN/Player Options/Spells/Detailed Spells/Cloudkill\|Cloudkill]], [[EN/Player Options/Spells/Detailed Spells/Raise Dead\|Raise Dead]] |
...
>
> **Creating Additional Elixirs.** As a Magic action while holding Alchemist’s Supplies, you can expend one spell slot to create another elixir.
>
...
> ##### Level 9 Alchemist Feature
>
> You can cast [[EN/Player Options/Spells/Detailed Spells/Lesser Restoration\|Lesser Restoration]] without expending a spell slot and without preparing the spell, provided you use Alchemist’s Supplies as the Spellcasting Focus.
>
...
> [!class-feature|artificer]
> #### Chemical Mastery
> ##### Level 15 Alchemist Feature
>
> You gain the following benefits.
>
> - **Alchemical Eruption.** When you cast an Artificer spell that deals Acid, Fire, or Poison damage to a target, you can also deal 2d8 Force damage to that target.
>
...
>
> - **Conjured Cauldron.** You can cast [[Tasha’s Bubbling Cauldron\|Tasha’s Bubbling Cauldron]] without expending a spell slot, without preparing the spell, and without Material components, provided you use Alchemist’s Supplies as the Spellcasting Focus.
>
