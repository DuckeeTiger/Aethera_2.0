---
{"dg-publish":true,"permalink":"/en/player-options/classes/cleric/cleric/","noteIcon":"","dg-note-properties":{"tr_id":"cleric","tr_lang":"en","translation":"[[HU/Player Options/Classes/Cleric/Cleric|Cleric]]"}}
---
...
>
> Clerics draw power from the realms of the gods and harness it to work miracles. Blessed by a deity, a pantheon, or another immortal entity, a Cleric can reach out to the divine magic of the Outer Planes and channel it to bolster people and battle foes.
>
...
>
> Not every member of a temple or shrine is a Cleric. Some priests are called to a simple life of temple service, carrying out their devotion through prayer and rituals rather than through magic.
>
> Many mortals claim to speak for the gods, but few can marshal divine power the way a Cleric can.
...
> [!class-table|cleric]
> | Level | Prof. Bonus | Class Features | Channel Divinity | Cantrips | Prepared Spells | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 |
> | ----- | ----------- | ----- | ----- | ----- | ----- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
