---
{"dg-publish":true,"permalink":"/en/player-options/classes/druid/druid/","noteIcon":"","dg-note-properties":{"tr_id":"druid","tr_lang":"en","translation":"[[HU/Player Options/Classes/Druid/Druid|Druid]]"}}
---
...
>
> Druids are concerned with the delicate ecological balance that sustains plant and animal life and with the need for people to live in harmony with nature.
>
> Druids often guard sacred sites or watch over regions of unspoiled nature, but when a significant danger arises, Druids take a more active role as adventurers who combat the threat.
...
> [!class-table|druid]
> | Level | Prof. Bonus | Class Features | Wild Shape | Cantrips | Prepared Spells | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 |
> | ----- | ----------- | ----- | ----- | ----- | ----- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
