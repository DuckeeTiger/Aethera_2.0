---
{"dg-publish":true,"permalink":"/en/player-options/classes/rogue/rogue/","noteIcon":"","dg-note-properties":{"tr_id":"rogue","tr_lang":"en","translation":"[[HU/Player Options/Classes/Rogue/Rogue|Rogue]]"}}
---
...
>
> Rogues rely on cunning, stealth, and their foes’ vulnerabilities to gain the upper hand in any situation. They have a knack for finding solutions where others see only obstacles.
>
> Many Rogues focus on stealth and deception, while others refine talents useful in dangerous environments, such as climbing, disarming traps, opening locks, and uncovering hidden secrets.
>
> In combat, Rogues favor precision over brute force. They would rather strike once at exactly the right moment than overwhelm an enemy with a flurry of attacks.
>
> Some Rogues begin their careers as criminals, while others use their talents to hunt criminals. Whatever their relationship with the law, few can match the subtle brilliance of a master Rogue.
...
- Gain the following traits from the Core Rogue Traits table: Hit Point Die, proficiency in one skill of your choice from the Rogue skill list, proficiency with Thieves' Tools, and training with Light armor.
- Gain the Rogue’s level 1 features, which are listed in the Rogue Features table.
